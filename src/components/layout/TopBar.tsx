  ...
  return (
    <header className="h-16 bg-[#111c44] border-b border-[#1f2d5e] flex items-center justify-between px-4 lg:px-6">
      <div className="flex items-center gap-3">
        {onToggleSidebar && (
          <button
            ...
            className="p-2 rounded-lg bg-[#0b1437] border border-[#1f2d5e] hover:border-[#dc2626] lg:hidden"
        ...
        <input
          type="search"
          placeholder="Search..."
          className="w-60 md:w-96 px-4 py-2 bg-[#0b1437] border border-[#1f2d5e] rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-[#dc2626]"
        />
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={signOut}
          className="px-4 py-2 bg-[#dc2626] hover:bg-[#b91c1c] text-white text-sm font-medium rounded-lg transition"
        >
          Logout
        </button>
      </div>
